...
# nohup python train_kitti.py 1> /dev/null 2>&1 &
...
parser.add_argument('--datapath_12', default="/home/jnu-ie/Dataset/KITTI_2012/data_stereo_flow/", help='data path')
parser.add_argument('--datapath_15', default="/home/jnu-ie/Dataset/KITTI_2015/data_scene_flow/", help='data path')
...
parser.add_argument('--lrepochs', type=str, default="200,400,500,550:2", help='the epochs to decay lr: the downscale rate')

parser.add_argument('--logdir', default='./checkpoints/PW_Stereo_v3-halfedge/', help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default='/home/jnu-ie/kew/blockstereo/checkpoints/PW_Stereo_v3-sceneflow/best-D1.ckpt', help='load the weights from a specific checkpoint')
